...
const page = () => {
  return (
    <div className="bg-[rgba(250, 251, 252, 1)]">
      ...
      <Search />
      <section className="mx-24pxr mb-40pxr mt-101pxr flex flex-col gap-16pxr tablet:mt-110pxr pc:mt-126pxr">
      ...
      <Option />
      <section className="mx-24pxr mb-24pxr mt-24pxr flex flex-col gap-24pxr tablet:mt-35pxr tablet:gap-32pxr">
