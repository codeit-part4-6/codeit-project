...
const Search = () => {
  return (
    <div className="flex flex-col items-center justify-center">
      <div className="absolute flex h-auto w-11/12 flex-col gap-15pxr rounded-2xl bg-white px-24pxr py-16pxr shadow-lg tablet:gap-8 tablet:px-6 tablet:py-8">
        ...
        <div className="flex justify-between gap-10pxr">
          ...
          <Button className="inline-flex h-56pxr w-auto items-center whitespace-nowrap rounded bg-nomad-black px-20pxr py-8pxr text-lg font-bold text-white tablet:px-10 tablet:py-2">
            검색하기
          </Button>
        </div>
      </div>
